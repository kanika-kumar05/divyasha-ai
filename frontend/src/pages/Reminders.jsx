        ...
        <Layout>
            <div className="p-8">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="bg-white/90 backdrop-blur p-6 rounded-2xl shadow-lg border border-white mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {medicines.length === 0 && (
                            <div className="bg-white/90 backdrop-blur p-6 rounded-2xl shadow-lg border border-white text-gray-500">
                        ...
                        {medicines.map((medicine) => (
                            <div
                                key={medicine.id}
                                className="bg-white/90 backdrop-blur p-6 rounded-2xl shadow-lg border border-white"
                            >
